 ...
 * except the integers of the given array are not necessarily distinct[不同],
...
we split the array into some number of "chunks[块]" (partitions), 
and individually[分别] sort each chunk.  
