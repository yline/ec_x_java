...
/**
 * There is a robot starting at position (0, 0), the origin, on a 2D plane[飞机]. 
 * Given a sequence of its moves, judge if this robot ends up at (0, 0) after it completes its moves.

The move sequence is represented[代表] by a string, 
...
Note: 
The way that the robot is "facing" is irrelevant[无关]. 
"R" will always make the robot move to the right once, 
"L" will always make it move left, etc. 
Also, assume that the magnitude[量级] of the robot's movement is the same for each move.
